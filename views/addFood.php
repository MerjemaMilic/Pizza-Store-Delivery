				...
				<form class="col-md-12" action="addFood/createFood" method="POST" enctype="multipart/form-data">
				  <div class="form-row">
				    <div class="col-md-4 mb-4">
				      ...
				      <input class="form-control form-special" type="text" name="food_name" placeholder="food name" id="validationTooltip01" required>
				    </div>
				    <div class="col-md-4 mb-4">
				    ...
				    <div class="col-md-4 mb-4">
				      ...
				      <input class="form-control form-special" type="file" name="food_image" placeholder="picture" id="validationTooltip01" required style="font-size: 12px;">
				  ...
				  <div class="form-row">
				    <div class="col-md-3 mb-4">
				      ...
				      <input class="form-control form-special" type="text" style="height:165px !important;text-align: center;font-size: 72px" name="food_price" placeholder="0.00" id="validationTooltip01" required>
				    </div>
				    <div class="col-md-9 mb-4">
				      <label for="validationTooltip01">Deskripcija</label>
				      <textarea class="form-control form-special" type="text" name="food_description" placeholder="food description" id="validationTooltip01" required rows="5"></textarea>
				    </div>
				  </div>
