  ...
  <div class="row">
    <div class="col-md-12 mt-1">
      <div class="alert alert-success mt-3" role="alert">
        <p>Ovdje možete da vidite listu trenutačno dostupnih jela, tj. menu, da dodajete nove ponude i da brišete već postojeće.</p>
      ...
      <div class="alert alert-info" role="alert" style="font-size: 14px;font-weight: 700;">
        <div class="row">
          <div class="col-md-12" style="border-bottom: 1px solid #aaa; padding-bottom: 10px;">
            <a data-toggle="collapse" href="#collapseOrders" role="button" aria-expanded="false" aria-controls="collapseOrders" style="color: #383d41;">Kategorije</a>
  ...
  <?php foreach($result as $index => $category){ ?>
    ...
    <div class="col-md-12">
      <div class="alert alert-info" role="alert" style="font-size: 14px;font-weight: 700;">
        <div class="row">
          <div class="col-md-12" style="border-bottom: 1px solid #aaa; padding-bottom: 10px;">
            <a data-toggle="collapse" href="#collapse<?php echo $category['category'] ?>" role="button" aria-expanded="false" aria-controls="collapse<?php echo $category['category'] ?>" style="color: #383d41;"><?php echo $category['category'] ?></a>
            <form action="./addFood" method="POST" id="addFoodForm<?php echo $category['category']?>" style="float: right">
              <button type="submit" class="btn btn-sm btn-info" form="addFoodForm<?php echo $category['category']?>">Dodaj</button>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <th class="d-flex">
                    ...
                    <form action="./deleteFood" method="POST" id="deleteFoodForm<?php echo $food['id']; ?>">
                      <button type="submit" class="btn btn-sm btn-danger order-button" form="deleteFoodForm<?php echo $food['id']; ?>">
                        <i class="fas fa-times"></i>
                      </button>
