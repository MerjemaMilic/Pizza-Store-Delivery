  ...
  <div class="row">
    <div class="col-md-12 mt-1">
      <div class="alert alert-success mt-3" role="alert">
        <p>Dobrodošli na vaš control panel. Ovdje možete vidjeti broj registrovanih korisnika, broj trenutnih narudžbi, broj poruka i messenger listu (subscriptions).</p>
        <hr>
        <p>Ukoliko želite da vidite listu trenutačno dostupnih jela, tj. menu, nastavite na "MENU" link u navbaru.</p>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-3">
      <div class="alert panel-alert-counter-wrapper alert-primary" role="alert">
        <div class="row">
          ...
          <div class="col-md-12 panel-alert-counter-number"><?php echo Flight::panelCount()->totalUsers() ?></div>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="alert panel-alert-counter-wrapper alert-info" role="alert">
        <div class="row">
          ...
          <div class="col-md-12 panel-alert-counter-number"><?php echo Flight::panelCount()->totalPendingOrders() ?></div>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="alert panel-alert-counter-wrapper alert-success" role="alert">
        <div class="row">
          ...
          <div class="col-md-12 panel-alert-counter-number"><?php echo Flight::panelCount()->totalMessages() ?></div>
        </div>
      </div>
    </div>
    <div class="col-md-3">
      <div class="alert panel-alert-counter-wrapper alert-warning" role="alert">
        <div class="row">
          ...
          <div class="col-md-12 panel-alert-counter-number"><?php echo Flight::panelCount()->totalOrders() ?></div>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="alert alert-info" role="alert" style="font-size: 14px;font-weight: 700;">
        <div class="row">
          <div class="col-md-12" style="border-bottom: 1px solid #aaa; padding-bottom: 10px;">
            <a data-toggle="collapse" href="#collapseOrders" role="button" aria-expanded="false" aria-controls="collapseOrders" style="color: #383d41;">Narudžbe na čekanju</a>
          </div>
            ...
            <table class="table" style="color: #383d41">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <th><?php echo $pendingOrder['first_name'] . " " . $pendingOrder['last_name']; ?></th>
                  <th><?php echo(substr(((explode(" ", $pendingOrder['dateTime']))[1]), 0, 5)); ?></th>
                  <th><?php echo $pendingOrder['telephone']; ?></th>
                  <th><?php echo $pendingOrder['address']; ?></th>
                  <th class="d-flex">
                    <form action="/panel/orderProcessed/" method="POST" style="margin-right: 5px;">
                      <button type="submit" class="btn btn-sm btn-success order-button">
                        <i class="fas fa-check"></i>
                      </button>
                      <input name="orderID" type="hidden" value="<?php echo $pendingOrder['id']; ?>">
                    </form>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="alert alert-info" role="alert" style="font-size: 14px;font-weight: 700;">
        <div class="row">
          <div class="col-md-12" style="border-bottom: 1px solid #aaa; padding-bottom: 10px;">
            <a data-toggle="collapse" href="#collapseMessages" role="button" aria-expanded="false" aria-controls="collapseMessages" style="color: #383d41;">Poruke</a>
          </div>
                ...
                <tr>
                  ...
                  <th>
                    <form action="/panel/messages/<?php echo $message['id'];?>" method="POST">
                      ...
                      <input name="messageID" type="hidden" value="<?php echo $message['id']; ?>">
                    </form>
                  </th>
                </tr>
                <?php } ?>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="alert alert-info" role="alert" style="font-size: 14px;font-weight: 700;">
        <div class="row">
          <div class="col-md-12" style="border-bottom: 1px solid #aaa; padding-bottom: 10px;">
            <a data-toggle="collapse" href="#collapseUsers" role="button" aria-expanded="false" aria-controls="collapseUsers" style="color: #383d41;">Korisnici</a>
          </div>
            ...
            <table class="table" style="color: #383d41">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <th>
                    <form action="/panel/users/<?php echo $user['id']; ?>" method="POST" id="userDelete<?php echo $user['id']; ?>">
                      <button type="submit" class="btn btn-sm btn-danger order-button" form="userDelete<?php echo $user['id']; ?>">
                        <i class="fas fa-times"></i>
                      </button>
